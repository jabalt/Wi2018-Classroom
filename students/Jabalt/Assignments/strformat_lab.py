...
print('{:10}{:10}{:>15}'.format('James', '29', '$0.0'))
print('{:10}{:10}{:>15}'.format('Henry', '63', '$8.00'))
print('{:10}{:10}{:>15}'.format('Jackson', '29', '$500,000,000.00'))
print('{:10}{:10}{:>15}'.format('Matthew', '30', '$60.00'))
print('{:10}{:10}{:>15}'.format('Thomson', '48', '$100,1467.00'))
print('{:10}{:10}{:>15}'.format('Nancy', '37', '$100.000,000'))
